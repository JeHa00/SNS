...
class CommentService:
    ...
    def get_comment_and_handle_none(
        ...
        """주어진 정보에 해당되는 댓글을 조회하고, 없을 경우 404 에러를 발생시킵니다.
    ...
    def get_user_and_handle_none(
        self,
        db: Session,
        user_id: int,
    ) -> User:
        """주어진 정보에 해당되는 유저를 조회하고, 없을 경우 404 에러를 발생시킵니다.
    ...
    def get_comments_of_a_user(
        ...
        """
        # 유저 유무 확인
        self.get_user_and_handle_none(db, user_id)
    ...
    def create_comment(
        ...
        """
        # 유저 유무 확인
        self.get_user_and_handle_none(db, writer_id)
