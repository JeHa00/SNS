...
class PostDB:
    ...
    def get_multi_posts(self, db: Session, writer_id: int, skip: int = 0, limit: int = 100) -> List[Post]:
    ...
    def update(self, db: Session, post_info: Post | int, data_to_be_updated: PostUpdate) -> Post:
